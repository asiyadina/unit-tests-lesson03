...
//
//
////3) Нужно написать метод который проверяет, попадает ли переданное число в интервал (25;100) возвращает true, если
//// попадает и false - если нет, покрыть тестами метод на 100%
//    public boolean numberInInterval(int n) {
//	Scanner Scan = new Scanner(System.in);
//	int n = n;
//	if ((25 < n)&&(n < 100)) System.out.printf("%d ∈ (25,100)",n);
//        else System.out.printf("%d ∉ (25,100)",n);
//
// }
//5.Добавить возможность наделять админскими правами пользователя (User), добавить функцию в UserRepository (TDD),
